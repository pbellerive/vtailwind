        ...
        css: {
          ...
          variant: {
            default: {
              ...
              baseCss:
                'flex-1 text-center font-regular relative mb-4 block w-full text-base leading-5  opacity-100',
              bgCss: 'bg-blue-500 text-white',
              closeButtonCss:
                'absolute top-1 right-1 self-end px-3 font-bold hover:text-gray-600 cursor-pointer'
            },
            danger: {
